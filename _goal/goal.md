...
Explore the datasets from many different angles as described in the goal section, particularly those that us researchers might not think of.

At appropriate points create/update the file `output/status.md` with time stamps so that we can see what the progress is. This is for users to view so make it in plain English with any diagrams you may want to add.
